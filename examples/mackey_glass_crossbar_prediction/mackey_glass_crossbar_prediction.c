...
int main(void) 
{
    ...
    online_crossbar_config crossbar_config = {
        ...
        .r_on = 1000.0,
        .r_off = 100000.0,
        .model_path = "../../src/crossbar_readout/models/yakopcic_memristor.cir",
        .subcircuit_name = "MEM_YAKOPCIC",
    };

    double *crossbar_outputs = spires_run_crossbar_readout_into(
    ...
    for (size_t i = 0; i < series_length; i++) {
        fprintf(output_file, "%zu %f %f\n", i, input_series[i], crossbar_outputs[i]);
    }
