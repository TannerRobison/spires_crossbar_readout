...
struct psc_heterogeneous_synapse_data *synapse_psc_heterogeneous_build_sparse(const double *dense, size_t n, const double *params, struct spires_rng *rng);
struct psc_heterogeneous_synapse_data *synapse_psc_heterogeneous_build_dense(const double *dense, size_t n, const double *params, struct spires_rng *rng);
